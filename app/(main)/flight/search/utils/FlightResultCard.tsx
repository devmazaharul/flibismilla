...
export const FlightResultCard = ({ flight }: { flight: FlightOffer }) => {
    ...
    const handleSelectFlight = () => {
        // 🟢 Get current search parameters to pass to checkout
        ...
        // 🟢 Push everything to checkout page
        router.push(`/checkout?offer_id=${flight.id}&adt=${adt}&chd=${chd}&inf=${inf}&type=${type}`);
    };
                                        ...
                                        <div className="bg-white p-4 rounded-xl border border-slate-200/80 shadow-2xl shadow-gray-100 flex flex-col gap-4">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <span className="text-xs  text-slate-500">{seg.departure.airport} ({seg.departure.code})</span>
                                                </div>
