...
const Navbar = () => {
    ...
    return (
        ...
        <header className="w-full relative  bg-white">
            ...
            {/* ================= 2. Main Navigation ================= */}
            {/* 🟢 Change: Removed scroll logic, set permanent bg-white and padding */}
                ...
                <div className={`${layout.container} flex justify-between items-center h-14 md:h-20 lg:h-22`}>
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        <div className="hidden sm:flex items-center gap-2 md:gap-3">
                            <Button variant="ghost" asChild className="font-bold text-gray-700 hover:text-rose-600 hidden md:inline-flex">
                                <Link href={'/login'}>Log In</Link>
                            </Button>
                            <Button asChild className="bg-rose-600 hover:bg-rose-700 text-white px-4 md:px-6 rounded-xl font-bold shadow-lg shadow-rose-500/20 active:scale-95 transition-all text-xs md:text-sm">
                                ...
                                <SheetContent side="right" className="bg-white w-[85vw] sm:w-[380px] p-0 flex flex-col h-full border-l-0 z-[110]">
                                    ...
                                    <div className="flex-1 overflow-y-auto px-4 py-4 custom-scrollbar">
                                        ...
                                        <div className="mt-8 space-y-3 px-2">
                                            <Button variant="outline" asChild className="w-full h-12 font-bold text-gray-700 border-gray-200 md:hidden">
                                                <Link href={'/login'}>Log In</Link>
                                            </Button>
