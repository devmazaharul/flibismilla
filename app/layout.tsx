...
export const metadata: Metadata = {
    ...
    description:
        'Your best travel partner for Hajj, Umrah, and holiday packages. We provide flight booking, hotel reservation, and visa processing services in Bangladesh and USA.',
    keywords: [
        'Travel Agency',
        'Hajj Package 2026',
        'Umrah Visa',
