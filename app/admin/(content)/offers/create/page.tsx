...
export default function CreateOfferForm() {
  ...
  const { 
    ...
    defaultValues: {
      isLarge: false,
      isActive: true,
      whatsappMessage: "Hi, I am interested in this offer!"
    }
  });
  ...
  const onSubmit = async (data: offerFormValues) => {
    setLoading(true);
    try {
      const response = await axios.post('/api/dashboard/offers', data);
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
             ...
             <div>
               <h1 className="text-2xl font-bold tracking-tight text-gray-900">New Offer</h1>
               <p className="text-sm text-gray-500 mt-1">Create a promotional campaign</p>
             </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="Message to send when user clicks"
                    className="w-full h-12 px-4 rounded-xl border border-gray-200 bg-gray-50/30 focus:bg-white focus:border-gray-900 focus:ring-4 focus:ring-gray-100 transition outline-none"
                  />
          ...
          <div className="space-y-6">
            ...
            {/* Offer Image Input (Missing in your code) */}
            <div className={cardClass}>
              <div className="p-6 space-y-4">
