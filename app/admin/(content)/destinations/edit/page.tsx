...
import { DestinationformSchema, DestinationFormValues } from '../../validation/destination';
...
function EditDestinationFormContent() {
  ...
  useEffect(() => {
    const fetchDestination = async () => {
      ...
      try {
        const response = await axios.get(`/api/dashboard/destinations/${destinationId}`);
  ...
  const onSubmit = async (data: DestinationFormValues) => {
    ...
    setSaving(true);
    try {
      const response = await axios.put(`/api/dashboard/destinations/${destinationId}`, data);
  ...
  if (!destinationId) return <div className="p-10 text-center text-red-500">Invalid Destination ID</div>;
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
             ...
             <div>
               <h1 className="text-2xl font-bold tracking-tight text-gray-900">Edit Destination</h1>
               <p className="text-sm text-gray-500 mt-1">Update details for {nameValue}</p>
             </div>
          </div>
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                       ...
                       <input {...register('bestTime')} className="w-full h-10 pl-9 pr-3 text-sm rounded-lg border border-gray-200 focus:border-gray-900 outline-none transition" />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                         ...
                         <div className="relative">
                           ...
                           <input {...register('currency')} className="w-full h-10 pl-8 pr-2 text-sm rounded-lg border border-gray-200 focus:border-gray-900 outline-none transition" />
                         </div>
                      ...
                      <div className="space-y-1">
                         ...
                         <div className="relative">
                           ...
                           <input {...register('language')} className="w-full h-10 pl-8 pr-2 text-sm rounded-lg border border-gray-200 focus:border-gray-900 outline-none transition" />
                         </div>
