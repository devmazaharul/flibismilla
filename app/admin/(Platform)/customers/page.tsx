...
export default function PassengerListPage() {
    ...
    () =>
      passengers.filter(
        (p) =>
          ...
          p.lastPnr?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  if (loading && passengers.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-slate-50 to-emerald-50">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-slate-50 to-emerald-50 px-4 py-8 md:px-6">
        ...
        <section className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Total {totalPassengers} unique passengers with recent booking and
