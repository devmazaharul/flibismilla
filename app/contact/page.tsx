...
const ContactPage = () => {
  ...
  const getIcon = (icon: string) => {
    ...
    switch (icon) {
      case "map": return <FaMapMarkerAlt className={style} />;
      case "phone": return <FaPhoneAlt className={style} />;
      default: return <FaEnvelope className={style} />;
    }
  };
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            {contactPageData.info.locations.map((loc) => (
              <div key={loc.id} className="flex gap-4 bg-white p-6 rounded-2xl shadow-2xl shadow-gray-100 border border-gray-200/70 transition-shadow">
                <div className="w-12 h-12 bg-rose-600 rounded-full flex items-center justify-center shrink-0 shadow-lg shadow-rose-200">
                  {getIcon(loc.icon)}
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-1">{loc.city}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {contactPageData.info.contacts.map((contact) => (
                ...
                >
                  ...
                  <h4 className="text-gray-500 font-medium text-sm uppercase tracking-wider mb-2">{contact.label}</h4>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <input
                  {...register("name")}
                  className={`w-full p-3 rounded-lg border bg-gray-50 focus:bg-white transition-all outline-none ${errors.name ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-100"}`}
            ...
            <div className="space-y-2">
              ...
              <input
                {...register("email")}
                className={`w-full p-3 rounded-lg border bg-gray-50 focus:bg-white transition-all outline-none ${errors.email ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-100"}`}
            ...
            <div className="space-y-2">
              ...
              <input
                {...register("subject")}
                className={`w-full p-3 rounded-lg border bg-gray-50 focus:bg-white transition-all outline-none ${errors.subject ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-100"}`}
            ...
            <div className="space-y-2">
              ...
              <textarea
                {...register("message")}
                rows={4}
                className={`w-full p-3 rounded-lg border bg-gray-50 focus:bg-white transition-all outline-none resize-none ${errors.message ? "border-red-500 focus:ring-red-200" : "border-gray-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-100"}`}
