...
const FlightSearchPage = () => {
    ...
    return (
        <main className="min-h-screen bg-gray-50 pb-20">
            {/* demo messae alret section */}
            <div>
                <div
                    className={`bg-rose-100 border-l-4 border-rose-500 text-rose-700 p-4 mb-6`}
                    role="alert"
                >
                    <p className="font-bold">Demo Notice</p>
                    <p className="text-sm">
                        This is a demo flight search page. The flight data and search functionality
                ...
                <div className="hidden lg:block lg:col-span-1 space-y-6">
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-2xl shadow-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-xs text-rose-600 font-bold cursor-pointer">
                                Reset
                            </span>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {['Emirates', 'Qatar Airways', 'Turkish Airlines', 'Biman'].map(
                                    (air, i) => (
                                        <label
                                            key={i}
                                            className="flex items-center gap-2 cursor-pointer"
                    ...
                    <div className="flex-1 flex flex-col items-center px-4">
                        ...
                        <div className="w-full flex items-center gap-1">
                            <div className="h-[2px] bg-gray-300 flex-1 relative">
                                ...
                                {flight.stops > 0 && (
                                    <div
                                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-white border-2 border-rose-500 rounded-full"
                                        title={flight.stopInfo}
                                    ></div>
                                )}
                            </div>
                        ...
                        <p
                            className={`text-xs mt-1 font-bold ${
                                flight.stops === 0 ? 'text-green-600' : 'text-rose-600'
                            }`}
                        >
                            {flight.stopInfo}
                        </p>
                ...
                <div className="bg-white border-t border-gray-200 p-6 animate-in slide-in-from-top-2">
                    {flight.stops === 0 ? (
                        <div className="flex items-center gap-3 text-gray-600 bg-green-50 p-4 rounded-lg border border-green-100">
                            ...
                            <span>
                                Direct flight from <strong>{flight.fromCity}</strong> to{' '}
                                <strong>{flight.toCity}</strong>. No layovers.
                            </span>
                        </div>
                    ) : (
                        <div className="space-y-6 relative">
                            ...
                            <div className="flex items-center gap-4 relative z-10 pt-2">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-800 text-sm">
                                        Arrive at {flight.toCity} ({flight.toCode})
                                    </h4>
                                </div>
                            </div>
                        </div>
