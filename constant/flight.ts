...
export const flightResultsForAnyType = [
  ...
  // 1. Dhaka to Cox's Bazar (Most Popular Route)
  {
    id: 1,
    type: 'domestic',
  ...
  // 2. Dhaka to Chittagong (Major Business Route)
  {
    id: 5,
    type: 'domestic',
    airline: "US-Bangla Airlines",
  ...
  // 4. Dhaka to Saidpur (North Bengal)
  {
    id: 10,
    type: 'domestic',
    airline: "Novoair",
  ...
  // 5. Dhaka to Jashore (Khulna Region)
  {
    id: 12,
    type: 'domestic',
    airline: "US-Bangla Airlines",
  ...
  // --- International Flights (Preserved/Expanded) ---
  {
    id: 15,
    type: 'international',
  ...
  },
  {
    ...
    type: 'international',
    airline: "IndiGo",
    logo: getAirlineLogo("6E"),
    flightNumber: "6E-1861",
    fromCode: "DAC",
    fromCity: "Dhaka",
    toCode: "CCU",
    toCity: "Kolkata",
